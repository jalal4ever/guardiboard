...
- Fournis toujours les endpoints Microsoft Graph exacts (v1.0 de préférence, Bêta si strictement nécessaire) et spécifie les scopes de permissions (Application ou Delegated) selon le principe du moindre privilège.
- Tu dois **obligatoirement documenter tes appels complexes à Microsoft Graph** par des commentaires clairs dans le code généré, sans surcharger les fonctions évidentes.
